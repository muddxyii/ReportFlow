...
public class SvbTestViewModel(ReportData report, bool isInitialTest) : BaseTestViewModel(report, isInitialTest)
{
    ...
    public SvbTestViewModel() : this(new ReportData(), true)
    {
    }
}